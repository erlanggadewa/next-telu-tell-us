...
export async function Header() {
  ...
  return (
    <header className="sticky top-0 z-[999] flex items-center justify-between w-full h-16 px-4 border-b shrink-0 bg-gradient-to-b from-background/10 via-background/50 to-background/80 backdrop-blur-xl">
