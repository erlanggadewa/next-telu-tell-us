...
export default async function AuthenticationPage() {
  ...
  return (
    <div className="container h-screen md:grid lg:max-w-none lg:grid-cols-5 lg:px-0 lg:bg-gradient-to-b lg:from-[#ED1E28] lg:to-red-900">
      <div
      ...
      <div className="h-screen flex justify-between items-center flex-col col-span-2 lg:bg-white lg:rounded-tr-[45px] lg:drop-shadow-2xl">
        <div />
