                                ...
                                components={{
                                    a: ({children, href}) => {
                                        return <Link href={href||''} legacyBehavior passHref>
                                            <a target="_blank" className="text-blue-500 hover:underline">{children}</a>
                                        </Link>
                                    },
                                    ol: ({children}) => {
                                        return <ol className="flex flex-col gap-4 my-2">{children}</ol>
                                    },
                                    p: ({children}) => {
                                        return <pre className="last:mb-0 whitespace-pre-wrap font-sans">{children}</pre>
                                    },
                                }}
                            >
                                {message.content}
